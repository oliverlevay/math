...
const Solutions = () => {
  return (
    <Container>
      ...
      <Assignment author="Oliver" title={`b) $1, \\pi$`} id="6.18b">
        <Latex>{`$
        |z|=r=1${breakLine}
      ...
      <Assignment author="Oliver" title={`d) $1, \\frac{\\pi}{2}$`} id="6.18d">
        <Latex>{`$
        |z|=r=1${breakLine}
      ...
      <Assignment author="Oliver" title={`e) $1, 2\\pi$`} id="6.18e">
        <Latex>{`$
        |z|=r=1${breakLine}
        \\arg{z}=\\theta=
        \\pi\\backsimeq0
      ...
      <Assignment author="Oliver" title={`g) $1, -100\\pi$`} id="6.18g">
        <Latex>{`$
        |z|=r=1
        ${breakLine}
        $
      ...
      <Assignment author="Oliver" title={`a) $1$`} id="6.19a">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`b) $-13$`} id="6.19b">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`c) $i$`} id="6.19c">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`d) $-1+i$`} id="6.19d">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`e) $i\\sqrt{3}-1$`} id="6.19e">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`f) $\\sqrt{3}+3i$`} id="6.19f">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`Lösning`} id="6.23">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title={`Lösning`} id="6.24">
        <Latex>{`
      ...
      <Assignment author="Oliver" title={`Lösning`} id="6.25">
        <Latex>{`
      ...
      <Assignment author="Oliver" title={`a) $1+2iw$`} id="6.26a">
        <Latex>{`
      ...
      <Assignment author="Oliver" title={`b) $-1+2iw$`} id="6.26b">
        <Latex>{`
        Låt $z=a+bi$ och $\\theta$ ett argument till $z$. Eftersom Re$z$ motsvarar x-axeln och Im$z$ motsvarar y-axeln i ett koordinatsystem är $\\tan\\theta=\\frac{b}{a},~~a\\neq 0$.
        $${breakLine}$
        Om $a > 0$ är $\\theta=\\arctan\\frac{b}{a}$ och om $a < 0$ är $\\theta=\\pi+\\arctan\\frac{b}{a}$.
      ...
      <Assignment author="Oliver" title={`c) $\\dfrac{1}{1+2iw}$`} id="6.26c">
        <Latex>{`
        Låt $z=a+bi$ och $\\theta$ ett argument till $z$. Eftersom Re$z$ motsvarar x-axeln och Im$z$ motsvarar y-axeln i ett koordinatsystem är $\\tan\\theta=\\frac{b}{a},~~a\\neq 0$.
        $${breakLine}$
        Om $a > 0$ är $\\theta=\\arctan\\frac{b}{a}$ och om $a < 0$ är $\\theta=\\pi+\\arctan\\frac{b}{a}$.
      ...
      <Assignment author="Oliver" title={`d) $\\dfrac{1}{-1+2iw}$`} id="6.26d">
        <Latex>{`
        Låt $z=a+bi$ och $\\theta$ ett argument till $z$. Eftersom Re$z$ motsvarar x-axeln och Im$z$ motsvarar y-axeln i ett koordinatsystem är $\\tan\\theta=\\frac{b}{a},~~a\\neq 0$.
        $${breakLine}$
        Om $a > 0$ är $\\theta=\\arctan\\frac{b}{a}$ och om $a < 0$ är $\\theta=\\pi+\\arctan\\frac{b}{a}$.
      ...
      <Assignment author="Oliver" title="Lösning" id="6.27">
        <Latex>{`
      ...
      <Assignment author="Oliver" title="Lösning" id="6.28">
        <Latex>{`
      ...
      <Assignment author="Oliver" title="Lösning" id="6.29">
        <Latex>{`
      ...
      <Assignment author="Oliver" title="a) 1" id="6.32a">
        <Latex>{`
        ...
        1\\cdot(-\\dfrac{3\\sqrt{3}}{2}+\\dfrac{3}{2}i)=-\\dfrac{3\\sqrt{3}}{2}+\\dfrac{3}{2}i

        ${newLine}\\textbf{Svar: } -\\dfrac{3\\sqrt{3}}{2}+\\dfrac{3}{2}i
        $`}</Latex>
      </Assignment>
      <Assignment author="Oliver" title="b) -1+i" id="6.32b">
        <Latex>{`
        Vridning vinkeln $5\\pi/6$ i positiv led motsvarar att argumentet ökar med $5\\pi/6$ och skalan ökar med 3. $${breakLine}$
        Alltså ska de givna talen multipliceras med $1\\cdot e^{i5\\pi/6}\\cdot3=3(\\cos\\frac{5\\pi}{6}+i\\sin\\frac{5\\pi}{6})=3(-\\frac{\\sqrt{3}}{2}+\\frac{1}{2}i)=-\\frac{3\\sqrt{3}}{2}+\\frac{3}{2}i${newLine}
        
        (-1+i)(-\\dfrac{3\\sqrt{3}}{2}+\\dfrac{3}{2}i)=
        \\dfrac{3\\sqrt{3}}{2}-\\dfrac{3}{2}i-\\dfrac{3\\sqrt{3}}{2}i+\\dfrac{3}{2}i^2=
        (\\dfrac{3\\sqrt{3}}{2}-\\dfrac{3}{2})-(\\dfrac{3\\sqrt{3}}{2}+\\dfrac{3}{2})i=
        \\dfrac{3}{2}(\\sqrt{3}-1)-\\dfrac{3}{2}(\\sqrt{3}+1)i

        ${newLine}\\textbf{Svar: } \\dfrac{3}{2}(\\sqrt{3}-1)-\\dfrac{3}{2}(\\sqrt{3}+1)i
        $`}</Latex>
      </Assignment>
      <p>
        <Latex>{`6.34 Beräkna $e^z$ för följande $z$:`}</Latex>
      </p>
      <Assignment author="Oliver" title="a) $0$" id="6.34a">
        <Latex>{`$
        e^0=1
      ...
      <Assignment author="Oliver" title="b) $i\frac{\pi}{2}$" id="6.34b">
        <Latex>{`$
      ...
      <Assignment
        author="Oliver"
        title="c) $\frac{1}{2}\ln 2 + i\frac{\pi}{4}$"
        id="6.34c"
      >
        <Latex>{`$
        ...
        \\sqrt{2}\\left(\\frac{1}{\\sqrt{2}}+\\frac{1}{\\sqrt{2}}i\\right)=1+i

        ${newLine}\\textbf{Svar: } 1+i
        $`}</Latex>
      </Assignment>
      <Assignment author="Oliver" title="d) $i\pi$" id="6.34d">
        <Latex>{`$
      ...
      <Assignment author="Oliver" title="e) $3-i$" id="6.34e">
        <Latex>{`$
        e^{3-i}=e^3e^{-i}=e^3(\\cos(-1)+i\\sin(-1))=e^3\\cos1-ie^3\\sin1

        ${newLine}\\textbf{Svar: } e^3\\cos1-ie^3\\sin1
        $`}</Latex>
      </Assignment>
    </Container>
  );
